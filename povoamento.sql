...
INSERT INTO Animal(nome, espécie, raça, nascimento, peso, Cliente_cartão_cidadão)
VALUES
		('Shazod','Cão','Pug','2012-06-21','9.5 kg','123533413ZZ0'),
        ('Cucas','Gato','Ragdoll','2010-10-12','4.2 kg','043275817ZZ8'),
        ('Ágata','Cão','Beagle','2015-02-09','5.6 kg','014560922ZZ1'),
        ('Ace','Cão','Pastor-Alemão','2008-08-11','15.6 kg','156328001ZZ0'),
        ('Eletro','Gato','Persa','2012-01-13','3.5 kg','076120341ZZ8'),
        ('Dolly','Ovelha','Merino','2006-05-29','40.8 kg','068001853ZZ6'),
        ('Rafiki','Gato','Siamês','2013-09-14','5.4 kg','135345332ZZ2'),
        ('Ruca','Cão','Bulldog','2005-02-22','15.2 kg','033532140ZZ1'),
        ('Lili','Gato','Bombaim','2002-05-05','3.8 kg','045212244ZZ7'),
        ('Tumba','Cão','Cão-de-fila','2001-01-30','15.5 kg','082735831ZZ6'),
        ('Tshabs','Cão','Salsicha','2009-10-28','4.1 kg','054738491ZZ7'),
        ('Milka','Gato','Pixie-bob','2008-04-17','2.9 kg','034523569ZZ2'),
        ('Ryu','Cão','São Bernardo','2002-04-12','90.9 kg','104938573ZZ5'),
        ('Dona','Cão','Poodle','2011-06-27','3.5 kg','055256123ZZ3'),
        ('Paquito','Cão','Pitbull','2009-08-02','35.2 kg','000000000ZZ4'),
		('Camal','Hamster ','roborovski','2016-05-01','20 g','043275817ZZ8'),
        ('Mill','Iguana','Verde','2015-12-20','3.5 kg','082735831ZZ6'),
        ('Camel','Camaleão','Verde','2016-10-22','3 kg','082735831ZZ6'),
        ('Tata','Iguana','Verde','2015-12-20','3.5 kg','082735831ZZ6'),
        ('Kiara','Cão','Bulldog','2013-11-09','15 kg','104938573ZZ5'); 
          
INSERT INTO Consulta(data_consulta, hora_início, hora_fim, preço, Médico_id_médico, Animal_id_animal)
VALUES
		('2017-08-08','09:00','10:00','50',2,1),
        ('2017-08-08','10:00','11:00','50',3,15),
        ('2017-08-09','09:00','10:00','50',1,3),
        ('2017-08-10','10:00','11:00','20',4,9),
        ('2017-08-10','15:00','15:30','30',2,4),
        ('2017-08-11','10:00','11:00','20',3,10),
        ('2017-08-11','11:00','12:30','40',4,9),
		('2017-08-11','14:00','14:30','40',5,6),
		('2017-08-12','11:00','12:00','40',5,11),
		('2017-08-12','14:00','14:30','40',4,13);

INSERT INTO Diagnóstico(observações,Consulta_id_consulta)  -- 15 consultas para os 15 caes
VALUES
		('Não andar em espaço publico por 2 semanas',1),
        ('Arranha(ter cuidado na prox. consulta)',2),
        ('Nada a obs.',3),
        ('Nada a obs.',4),
        ('Angitimal está saudavel mas ter percaução',5),
        ('Nada a obs.',6),
        ('Tomar 1 comprimido por dia',7),
        ('Pesado! Perder peso!',8),
        ('Nada a obs.',9),
        ('Não andar em espaço publico por 1 semana',10);
       /* (11,'Nada a obs.',11),
        (12,'Nada a obs.',12),
